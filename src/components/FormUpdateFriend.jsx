...
const FormUpdateFriend = ({
  ...
  if (!friendConfirm || selectedFriends == 1) {
    ...
    const handleSubmit = (e) => {
      ...
      setFriends((cur) => {
        return cur.map((it) => {
          return it.id == formVal.id
            ? {
                ...it,
                me: formVal.me,
                total: formVal.total,
                friend: Number(formVal.total)-Number(formVal.me),
                owe:
                  formVal.me == formVal.friend
                    ? "none"
                    : formVal.who == "me"
                    ? "friend"
                    : "you",
    ...
    return (
      <form action="" className="form-split-bill" onSubmit={handleSubmit}>
        ...
        <input
          ...
          disabled
          name="friend"
          value={formVal.total - formVal.me}
        />
